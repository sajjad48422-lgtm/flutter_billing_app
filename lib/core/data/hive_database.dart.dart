...
import '../../features/sales/data/models/sale_record_hive_model.dart';
...
class HiveDatabase {
  ...
  static Future<void> init() async {
    ...
    Hive.registerAdapter(SaleRecordHiveModelAdapter());

    // Open Boxes
    await Hive.openBox<ProductModel>(productBoxName);
    await Hive.openBox<ShopModel>(shopBoxName);
    await Hive.openBox(settingsBoxName);
    await Hive.openBox<SaleRecordHiveModel>(salesBoxName);
  }
  ...
  static Box<SaleRecordHiveModel> get salesBox =>
      Hive.box<SaleRecordHiveModel>(salesBoxName);
}
